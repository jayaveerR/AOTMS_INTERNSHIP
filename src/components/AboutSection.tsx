        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="space-y-6 order-2 lg:order-1 text-center lg:text-left">
            <div className="flex justify-center lg:justify-start">
                <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-secondary text-primary text-sm font-semibold rounded-full uppercase tracking-wide">
                    About Us
                </span>
            </div>

            <h2 className="section-heading">
                Building <span className="text-primary">Careers</span>, Not Just <span className="text-accent">Courses</span>
            </h2>

            <p className="section-subheading !text-base mx-auto lg:mx-0">
          ...
          <motion.div
            ...
            className="relative order-1 lg:order-2 flex items-center justify-center h-[320px] md:h-[400px] lg:h-auto"
          >
            <motion.div
