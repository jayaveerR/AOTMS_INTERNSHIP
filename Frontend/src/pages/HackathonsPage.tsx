    ...
    const handleRegister = async () => {
        ...
        try {
            await fetch(`http://localhost:5000/api/events/hackathons/${selectedHackathon.id}/register`, {
                ...
                body: JSON.stringify({ name: "Unknown (Button Click)", email: "click_tracking@example.com" }),
            });
        } catch (error) { console.error("Failed to log registration click:", error); }
    ...
    return (
        <div className="bg-slate-50 min-h-screen relative text-slate-800 selection:bg-[#FF6B35]/20">
            ...
            <main className="pt-32 md:pt-40 pb-20 container mx-auto px-6 max-w-7xl relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:h-[650px] h-auto">
                    {/* Left Column: List */}
                                ...
                                <div className="bg-white shadow-xl shadow-slate-200/50 border border-slate-100 rounded-2xl p-6 md:p-10 relative overflow-hidden group">
                                    ...
                                    <div className="flex flex-col md:flex-row gap-8 relative z-10">
                                        ...
                                        <div className="flex-1 space-y-4">
                                            ...
                                            <p className="text-slate-600 leading-relaxed text-sm md:text-base border-l-2 border-slate-200 pl-4 py-2">
