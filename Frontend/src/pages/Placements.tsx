...
const Placements = () => {
    ...
    const [emblaRef] = useEmblaCarousel(
        ...
        // Increased speed slightly for better flow
            ...
            <section className="py-16 md:py-20 bg-[#005bb5] relative overflow-hidden">
                ...
                <div className="absolute inset-0 pointer-events-none">
                    ...
                    <div className="absolute inset-0 opacity-[0.08]"
                        style={{
                            backgroundImage: `url("data:image/svg+xml,%3Csvg width='28' height='49' viewBox='0 0 28 49' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%230066CC' fill-opacity='1' fill-rule='evenodd'%3E%3Cpath d='M13.99 9.25l13 7.5v15l-13 7.5L1 31.75v-15l12.99-7.5zM3 17.9v12.7l10.99 6.34 11-6.35V17.9l-11-6.34L3 17.9zM0 15l12.98-7.5V0h-2v6.35L0 12.69v2.3zm0 18.5L12.98 41v8h-2v-6.85L0 35.81v-2.3zM15 0v7.5L27.99 15H28v-2.31h-.01L17 6.35V0h-2zm0 49v-8l12.99-7.5H28v2.31h-.01L17 42.15V49h-2z'/%3E%3C/g%3E%3C/svg%3E")`,
                        }}
                    />
                    ...
                    <div className="absolute inset-0 opacity-[0.03]"
                        style={{
                            backgroundImage: `repeating-linear-gradient(45deg, transparent, transparent 2px, rgba(0, 102, 204, 0.1) 2px, rgba(0, 102, 204, 0.1) 4px)`
                        }}
                    />
                            ...
                            <div className="relative z-10">
                                ...
                                <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                                    ...
                                    <div>
                                        ...
                                        <select className="w-full h-12 rounded-xl bg-blue-800/50 border border-blue-400/30 text-white px-5 focus:outline-none focus:bg-blue-900/50 focus:border-orange-400/50 transition-all font-medium appearance-none cursor-pointer">
                                            <option className="bg-slate-900 text-white">Full Stack Development</option>
                                            <option className="bg-slate-900 text-white">Data Science & AI</option>
                                            <option className="bg-slate-900 text-white">Cyber Security</option>
                                            <option className="bg-slate-900 text-white">Cloud Computing (AWS/Azure)</option>
                                            <option className="bg-slate-900 text-white">Other</option>
                                        </select>
                                    </div>

                                    <button className="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold h-14 rounded-xl shadow-lg shadow-orange-500/25 hover:shadow-orange-500/40 hover:-translate-y-1 transition-all duration-300 mt-2 text-lg">
                                        Get Career Guidance
                                    </button>
